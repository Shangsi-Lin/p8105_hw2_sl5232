...
for clarity. Add a new variable called `wheel_name` to keep track of
which trash wheel does the data belong to.
...
in cubic yards, type of the trash, and homes powered. The total weight
of trash collected by Professor Trash Wheel is 135.5 tons. \# What was
